...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Plazas', href: '/utilities/places' },       // Página de listado
    { title: 'Crear', href: '/utilities/places/create' } // Página actual (crear)
];

// Componente principal para crear una plaza
export default function Create({ states }: { states: any[] }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/utilities/places', form, {
            onSuccess: () => {
            ...
            <div className="flex w-full justify-center py-6">
                <div className="w-full max-w-3xl px-6">
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        <h1 className="text-2xl font-bold">Añadir plaza</h1>
                    ...
                    <div className="mb-6">
                        ...
                        {infoOpen && (
                            <div className="mt-2 rounded border-l-4 border-blue-500 bg-gray-50 p-4 text-sm text-gray-700">
                                <p className="mb-2">
                                    Aquí puedes añadir nuevas plazas a la base
                                    de datos
                                </p>
                            </div>
                        )}
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Itera sobre todas las zonas que vinieron del backend */}
