                ...
                <div className="w-full max-w-3xl px-6">
                    ...
                    <div className="mb-6">
                        <button
                            ...
                            className="flex w-full items-center justify-between rounded bg-gray-100 px-4 py-2 text-left hover:bg-gray-200 dark:text-gray-600"
                        >
                        ...
                        {infoOpen && (
                            <div className="mt-2 rounded border-l-4 border-blue-500 bg-gray-50 p-4 text-sm text-gray-700">
                                ...
                                <p className="mb-2">
                                    En <strong>Título</strong> y{' '}
                                    <strong>Mensaje</strong> puedes usar
                                    variables entre llaves{' '}
                                    <code>{'{variable}'}</code>, como{' '}
                                    <code>{'{equipo}'}</code> o{' '}
                                    <code>{'{ip}'}</code>.
                                </p>
                                <p>
