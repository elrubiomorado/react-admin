...
class PlaceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $places = [
            ...
            ['name' => 'CABO SAN LUCAS', 'short_name' => 'CBCA', 'state' => 'BAJA CALIFORNIA SUR'],
            ...
            ['name' => 'CABO SAN LUCAS', 'short_name' => 'CSL', 'state' => 'BAJA CALIFORNIA SUR'],
            ['name' => 'DURANGO', 'short_name' => 'DGO', 'state' => 'DURANGO'],
            ['name' => 'GUAMÚCHIL', 'short_name' => 'GML', 'state' => 'SINALOA'],
            ['name' => 'GUERRERO', 'short_name' => 'GUE', 'state' => 'GUERRERO'],
            ...
            ['name' => 'MAZATLÁN', 'short_name' => 'MZT', 'state' => 'SINALOA'],
            ...
            ['name' => 'CHIAUTLA DE TAPIA (POSIBLE)', 'short_name' => 'CHD', 'state' => 'PUEBLA'],
            ...
            ['name' => 'SANTA CRUZ (POSIBLE)', 'short_name' => 'SCRZ', 'state' => 'SONORA'],
            ...
            ['name' => 'VALLE DE BRAVO', 'short_name' => 'VBVO', 'state' => 'ESTADO DE MÉXICO'],
            ...
            ['name' => 'CAMPECHE', 'short_name' => 'CAM', 'state' => 'CAMPECHE'],
            ...
            ['name' => 'CAMPECHE', 'short_name' => 'CPE', 'state' => 'CAMPECHE'],
            ...
            ['name' => 'MOROLEON', 'short_name' => 'MLN', 'state' => 'GUANAJUATO'],
            ...
            ['name' => 'PENJAMILLO', 'short_name' => 'PEN', 'state' => 'MICHOACÁN'],
            ['name' => 'PEÑJAMO', 'short_name' => 'PLQ', 'state' => 'GUANAJUATO'],
            ...
            ['name' => 'SALINA CRUZ', 'short_name' => 'SALA', 'state' => 'OAXACA'],
            ...
            ['name' => 'SAN LUIS POTOSÍ', 'short_name' => 'SLP', 'state' => 'SAN LUIS POTOSÍ'],
            ['name' => 'SAN MIGUEL DE ALLENDE', 'short_name' => 'SMAL', 'state' => 'GUANAJUATO'],

            ['name' => 'SAN LUIS POTOSI', 'short_name' => 'SLNP', 'state' => 'SAN LUIS POTOSÍ'],
            ['name' => 'TAMPICO', 'short_name' => 'TAM', 'state' => 'TAMAULIPAS'],
            ['name' => 'TIERRA BLANCA', 'short_name' => 'TBL', 'state' => 'VERACRUZ'],
            ['name' => 'TUXPAN', 'short_name' => 'TPX', 'state' => 'VERACRUZ'],
            ['name' => 'TUXTEPEC', 'short_name' => 'TTP', 'state' => 'OAXACA'],
            ['name' => 'TUXTEPEC', 'short_name' => 'TXC', 'state' => 'OAXACA'],
            ['name' => 'TUXPAN', 'short_name' => 'TXP', 'state' => 'VERACRUZ'],

            ['name' => 'VALLE DE BRAVO', 'short_name' => 'VAL', 'state' => 'ESTADO DE MÉXICO'],

            ['name' => 'VERACRUZ', 'short_name' => 'VER', 'state' => 'VERACRUZ'],
            ['name' => 'VILLAHERMOSA', 'short_name' => 'VLL', 'state' => 'TABASCO'],
            ['name' => 'VILLAHERMOSA', 'short_name' => 'VSA', 'state' => 'TABASCO'],
